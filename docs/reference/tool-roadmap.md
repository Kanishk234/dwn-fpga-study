...
**How it differs from the two docs beside it.** `docs/reference/reusable-generator.md` argues *whether* to
...
Only start once the generator has stopped changing. `docs/reference/reusable-generator.md` §5 gives the
...
`docs/reference/reusable-generator.md` §4, and still "almost none of it RTL". The estimate did not move;
...
- `docs/reference/reusable-generator.md` — whether to build the tool at all, and how to split it off
- `docs/jsc/report.md` §7 — the precision measurement F1 exists to expose
- `docs/reference/checkpoint-format.md` — what the exporter reads, verified against JSC only (M4)
